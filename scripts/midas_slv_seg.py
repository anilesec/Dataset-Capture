...
def midas_segm_sleeve(rgbs_dir, save_rt_dir, slv_clr, start_ind, end_ind, norm_type,
    ...
    for idx, imp in tqdm(enumerate(rgbs_pths[start_ind: end_ind])):
        ...
        fn_slv_mask = osp.join(save_rt_dir, 'slv_msk_midas', osp.basename(imp))
        ...
        fn_mask_wo_slv = osp.join(save_rt_dir, 'slvless_msk_midas', osp.basename(imp))
        ...
        fn_im_woslv = osp.join(save_rt_dir, 'slvless_img_midas', osp.basename(imp))
...
if __name__ == "__main__":
    ...
    midas_segm_sleeve(rgbs_dir=args.rgbs_dir, save_rt_dir=args.save_rt_dir, slv_clr=SLV_COLOR, start_ind=args.start_ind,
