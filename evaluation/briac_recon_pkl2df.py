...
BRIAC_RECON_RES_DIR = pathlib.Path('/scratch/1/user/aswamy/data/briac_recon_res')
...
if __name__ == "__main__":
    ...
    # get all sqn ids
    all_sqns = os.listdir(BRIAC_RECON_RES_DIR)
    ...
    for sqn in tqdm(all_sqns[args.start_ind: args.end_ind]):
        ...
        pkl_pth = osp.join(BRIAC_RECON_RES_DIR, sqn, args.pkl_name)
