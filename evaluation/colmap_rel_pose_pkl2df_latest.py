...
if __name__ == "__main__":
    ...
    for sqn in tqdm(all_sqns[args.start_ind: args.end_ind]):
        ...
        pkl_pth = pathlib.Path(osp.join(RES_DIR, sqn, 'eval_rel_pose_clmp_latest.pkl'))
    ...
    df_comb_save_pth = osp.join(RES_DIR, 'all_valid_seqs_colmap_rel_pose_all_framepairs_latest.csv')
